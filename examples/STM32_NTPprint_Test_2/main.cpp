...
void loop() {
  ...
  for(;;){
    ...
    Monitor.print(". ");
    Monitor.print(month[current_time.month]);
    Monitor.print(" ");
...
void gettime( u32 sec, struct time *t )
{
  ...
  u8 hour, wday, month, summertime, leap400;
  ...
  year = year + FIRSTYEAR / 100 * 100;	// + century
